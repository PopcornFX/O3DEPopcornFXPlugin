...
__LMBRPK_BEGIN
...
#if defined(PK_USE_EMOTIONFX)
            if (m_ShapeType == LmbrPk::PopcornFXSamplerShape::EShapeType::SkinnedMeshShape)
			{
				if (m_SkinnedMesh == null)
	...
	void	PopcornFXSamplerShape::_SetValuesNames()
	{
		switch (m_ShapeType)
		{
		case LmbrPk::PopcornFXSamplerShape::EShapeType::BoxShape:
			m_ValueXName = "Size X";
			m_ValueYName = "Size X";
			m_ValueZName = "Size Y";
			break;
		case LmbrPk::PopcornFXSamplerShape::EShapeType::SphereShape:
			m_ValueXName = "Radius";
			m_ValueYName = "InnerRadius";
			m_ShowValueZ = false;
			break;
		case LmbrPk::PopcornFXSamplerShape::EShapeType::CylinderShape:
		case LmbrPk::PopcornFXSamplerShape::EShapeType::CapsuleShape:
			m_ValueXName = "Radius";
			m_ValueYName = "Height";
			m_ValueZName = "InnerRadius";
			break;
		case LmbrPk::PopcornFXSamplerShape::EShapeType::MeshShape:
		case LmbrPk::PopcornFXSamplerShape::EShapeType::SkinnedMeshShape:
		case LmbrPk::PopcornFXSamplerShape::EShapeType::ShapeType_Max:
			break;
		default:
			break;
		}
