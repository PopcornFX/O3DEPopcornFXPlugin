...
CLmbrAtomBillboardingBatchPolicy::CLmbrAtomBillboardingBatchPolicy()
:	m_VertexCount(0)
,	m_ParticleCount(0)
...
bool	CLmbrAtomBillboardingBatchPolicy::AreBillboardingBatchable(const PCRendererCacheBase &firstCache, const PCRendererCacheBase &secondCache) const
{
	const CLmbrRendererCache	*firstLmbrCache = static_cast<const CLmbrRendererCache*>(firstCache.Get());
	const CLmbrRendererCache	*secondLmbrCache = static_cast<const CLmbrRendererCache*>(secondCache.Get());

	// Here, you need to implement a proper renderer cache compatibility check
	// Same materials/shader/uniforms/.. should return true
	return *firstLmbrCache == *secondLmbrCache; // overloaded == operator (see LmbrRendererCache.cpp)
}

//----------------------------------------------------------------------------

bool	CLmbrAtomBillboardingBatchPolicy::Tick(SLmbrAtomRenderContext &ctx, const TMemoryView<SLmbrAtomSceneView> &views)
{
...
bool	CLmbrAtomBillboardingBatchPolicy::AllocBuffers(SLmbrAtomRenderContext &ctx, const SBuffersToAlloc &allocBuffers, const TMemoryView<SLmbrAtomSceneView> &views, ERendererClass rendererType)
{
	PK_NAMEDSCOPEDPROFILE("CLmbrAtomBillboardingBatchPolicy::AllocBuffers");
	...
	CLmbrRendererCache *rendererCache = static_cast<CLmbrRendererCache*>(allocBuffers.m_RendererCaches.First().Get());
	if (!PK_VERIFY(rendererCache != null))
		return false;

	if (!m_Initialized)
	{
		PK_NAMEDSCOPEDPROFILE("CLmbrAtomBillboardingBatchPolicy::AllocBuffers Initialize");
		m_RenderContext = &ctx;
	...
	{
		PK_NAMEDSCOPEDPROFILE("CLmbrAtomBillboardingBatchPolicy::AllocBuffers Compute BBox");
...
bool	CLmbrAtomBillboardingBatchPolicy::MapBuffers(SLmbrAtomRenderContext &ctx, const TMemoryView<SLmbrAtomSceneView> &views, SBillboardBatchJobs *billboardBatch, const SGeneratedInputs &toMap)
{
...
bool	CLmbrAtomBillboardingBatchPolicy::MapBuffers(SLmbrAtomRenderContext &ctx, const TMemoryView<SLmbrAtomSceneView> &views, SRibbonBatchJobs *billboardBatch, const SGeneratedInputs &toMap)
{
	AZ_UNUSED(ctx); AZ_UNUSED(views); AZ_UNUSED(billboardBatch); AZ_UNUSED(toMap);
...
bool	CLmbrAtomBillboardingBatchPolicy::MapBuffers(SLmbrAtomRenderContext& ctx, const TMemoryView<SLmbrAtomSceneView>& views, SGPUBillboardBatchJobs* billboardBatch, const SGeneratedInputs& toMap)
{
...
bool	CLmbrAtomBillboardingBatchPolicy::MapBuffers(SLmbrAtomRenderContext &ctx, const TMemoryView<SLmbrAtomSceneView> &views, SGPURibbonBatchJobs *billboardBatch, const SGeneratedInputs &toMap)
{
...
bool	CLmbrAtomBillboardingBatchPolicy::MapBuffers(SLmbrAtomRenderContext &ctx, const TMemoryView<SLmbrAtomSceneView> &views, SMeshBatchJobs *billboardBatch, const SGeneratedInputs &toMap)
{
	AZ_UNUSED(ctx); AZ_UNUSED(views); AZ_UNUSED(billboardBatch); AZ_UNUSED(toMap);
...
bool	CLmbrAtomBillboardingBatchPolicy::MapBuffers(SLmbrAtomRenderContext &ctx, const TMemoryView<SLmbrAtomSceneView> &views, SDecalBatchJobs *decalBatch, const SGeneratedInputs &toMap)
{
...
bool	CLmbrAtomBillboardingBatchPolicy::LaunchCustomTasks(SLmbrAtomRenderContext &ctx, const TMemoryView<const Drawers::SBillboard_DrawRequest * const> drawRequests, Drawers::CBillboard_CPU *billboardBatch)
{
...
bool	CLmbrAtomBillboardingBatchPolicy::LaunchCustomTasks(SLmbrAtomRenderContext &ctx, const TMemoryView<const Drawers::SRibbon_DrawRequest * const> drawRequests, Drawers::CRibbon_CPU *ribbonBatch)
{
...
bool	CLmbrAtomBillboardingBatchPolicy::LaunchCustomTasks(SLmbrAtomRenderContext& ctx, const TMemoryView<const Drawers::SRibbon_DrawRequest* const> drawRequests, Drawers::CCopyStream_CPU* ribbonBatch)
{
	AZ_UNUSED(ctx); AZ_UNUSED(drawRequests); AZ_UNUSED(ribbonBatch);
	return true;
}
...
bool	CLmbrAtomBillboardingBatchPolicy::LaunchCustomTasks(SLmbrAtomRenderContext &ctx, const TMemoryView<const Drawers::SDecal_DrawRequest * const> drawRequests, Drawers::CDecal_CPU *decalBatch)
{
...
bool	CLmbrAtomBillboardingBatchPolicy::WaitForCustomTasks(SLmbrAtomRenderContext &ctx)
{
	AZ_UNUSED(ctx);
	return true;
}
...
bool	CLmbrAtomBillboardingBatchPolicy::UnmapBuffers(SLmbrAtomRenderContext &ctx)
{
	AZ_UNUSED(ctx);
	CRenderManager  *renderManager = m_RenderContext->m_RenderManager;
...
void	CLmbrAtomBillboardingBatchPolicy::ClearBuffers(SLmbrAtomRenderContext &ctx)
{
	AZ_UNUSED(ctx);
}
...
bool	CLmbrAtomBillboardingBatchPolicy::EmitDrawCall(SLmbrAtomRenderContext &ctx, const SDrawCallDesc &toEmit, SLmbrAtomDrawOutputs &output)
{
	...
	else if (m_RendererType == Renderer_Mesh)
	{
		...
		for (u32 i = 0; i < m_GeometryCache->m_PerGeometryViews.Count(); i++)
		{
			...
			// in CLmbrAtomPipelineCache::InitFromRendererCacheIFN and done once
...
bool        CLmbrAtomBillboardingBatchPolicy::_AllocViewIndependentBuffers(const SGeneratedInputs &inputs)
{
    PK_SCOPEDPROFILE();
    bool    success = true;
	// -----------------------------------------
...
bool        CLmbrAtomBillboardingBatchPolicy::_AllocViewDependentBuffers(const SGeneratedInputs &inputs)
{
    PK_SCOPEDPROFILE();
    bool    success = true;
	// -----------------------------------------
