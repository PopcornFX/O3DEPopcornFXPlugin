...
private:
	...
	void		DrawBar(float minX, float maxX, float yPos, float cursor, float thickness) const;
	void		DrawVBar(float minX, float maxX, float y, float value, float maxValue, float thickness) const;
