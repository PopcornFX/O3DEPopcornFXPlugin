...
namespace PopcornFX
{
	...
	public:
		...
		LmbrPk::PopcornFXEmitterRuntime*	m_EmitterInstance;
	...
	public:
		...
		virtual void						SpawnEmitterAtLocation(const AZStd::string& path, AZ::Transform transform) = 0;
		virtual AZ::EntityId				SpawnEmitterEntityAtLocation(const AZStd::string& path, AZ::Transform transform, bool start) = 0;
